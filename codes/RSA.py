...
betas_path = "/home/betas_products/"
...
for j in people:
    ...
    # working on images
        ...
        reaffined_mask = nilearn.image.resample_img(hc_mask, target_affine=participant_mask.affine, target_shape = participant_mask.get_fdata().shape, interpolation='nearest', fill_value=0)
